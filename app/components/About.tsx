          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                I&apos;m a passionate Full Stack Developer from Dhaka, Bangladesh, with over 1.5 years of 
                professional experience building scalable web applications. I specialize in the MERN stack 
                and have successfully delivered projects that improved performance by up to 35% and increased 
                user engagement significantly.
              </p>
              
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                My expertise spans from creating responsive frontends with React and Next.js to building 
                robust backends with Node.js and Express. I&apos;m passionate about writing clean, efficient 
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">React, Next.js, TypeScript, React Native</p>
                </div>
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-600 dark:text-green-400 mb-2">Backend</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Node.js, Express, REST APIs, JWT</p>
                </div>
                <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-600 dark:text-purple-400 mb-2">Database</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">MongoDB, Firebase, MySQL</p>
                </div>
                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-orange-600 dark:text-orange-400 mb-2">Tools</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">AWS, Git, Docker, Jest</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">mynul.sakil@gmail.com</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                    </svg>
                    <span className="text-gray-600 dark:text-gray-300">(+880) 1581477504</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
